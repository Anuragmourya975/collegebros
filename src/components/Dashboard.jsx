          ...
          <div class="px-6 flex items-center justify-between space-x-4 2xl:container">
            ...
            >
              ...
              <span className="hidden lg:block">
                <h3 className="text-2xl px-2 ">CollegeBros</h3>
              </span>
            </a>
            ...
            <div class="flex space-x-4">
              ...
              <button aria-label="user-profile">
                <img
                  src="https://images.pexels.com/photos/4355346/pexels-photo-4355346.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                  alt="user-profile"
